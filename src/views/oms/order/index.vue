...
<!--          </el-form-item>-->
    ...
    <div class="table-container">
      <el-table ref="orderTable"
        ...
        <el-table-column label="收货电话" width="120" align="center">
        ...
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-show="scope.row.orderStatus===101">关闭订单</el-button>
            <el-button
              size="mini"
              @click="handleDeliveryOrder(scope.$index, scope.row)"
              v-show="scope.row.orderStatus===201">订单发货</el-button>
            <el-button
              size="mini"
              @click="handleViewLogistics(scope.$index, scope.row)"
              v-show="scope.row.orderStatus===301">订单跟踪</el-button>
            <el-button
              size="mini"
              type="danger"
              @click="handleDeleteOrder(scope.$index, scope.row)"
              v-show="scope.row.orderStatus===102">删除订单</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
