  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="brandTable"
        ...
        <el-table-column label="品牌图片" width="170" align="center">
          <template slot-scope="scope"><img style="height: 80px" :src="scope.row.icon"></template>
        </el-table-column>
        <el-table-column label="品牌介绍" width="360" align="center">
...
<script>
  import {fetchList, updateStatus, deleteBrand} from '@/api/brand'
